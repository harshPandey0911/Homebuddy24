        ...
        cards: [
          {
            ...
            imageUrl: 'https://res.cloudinary.com/shubhamcloudinary/image/upload/v1766135138/Homebuddy24/electricity/service/home-wiring.jpg',
            badge: '',
            targetCategoryId: categories['home-wiring-installation']._id
          },
          {
            title: 'Panel Upgrade & Repair',
            imageUrl: 'https://res.cloudinary.com/shubhamcloudinary/image/upload/v1766135139/Homebuddy24/electricity/service/electrical-panel-upgrade.jpg',
            badge: '',
            targetCategoryId: categories['panel-upgrade-repair']._id
          },
          {
            title: 'Smart Home Setup',
            imageUrl: 'https://res.cloudinary.com/shubhamcloudinary/image/upload/v1766135140/Homebuddy24/electricity/service/smart-home-setup.jpg',
            badge: 'NEW',
        ...
        cards: [
          {
            ...
            imageUrl: 'https://res.cloudinary.com/shubhamcloudinary/image/upload/v1766135151/Homebuddy24/appliance/service/ac-repair.jpg',
            badge: '',
            targetCategoryId: categories['ac-service-repair']._id
          },
          {
            title: 'Washing Machine Repair',
            imageUrl: 'https://res.cloudinary.com/shubhamcloudinary/image/upload/v1766135152/Homebuddy24/appliance/service/washing-machine-repair-.jpg',
            badge: '',
            targetCategoryId: categories['washing-machine-repair']._id
          },
          {
            title: 'Water Heater Repair',
            imageUrl: 'https://res.cloudinary.com/shubhamcloudinary/image/upload/v1766135154/Homebuddy24/appliance/service/water-heater-repair.jpg',
            badge: '',
        ...
        cards: [
          {
            ...
            imageUrl: 'https://res.cloudinary.com/shubhamcloudinary/image/upload/v1766135147/Homebuddy24/electricity/service/wiring.jpg',
            badge: '',
          ...
          },
          {
            ...
            imageUrl: 'https://res.cloudinary.com/shubhamcloudinary/image/upload/v1766135144/Homebuddy24/electricity/service/fan.png',
            badge: '',
            targetCategoryId: categories['fan-repair']._id
          },
          {
            title: 'Switch & Socket Installation',
            imageUrl: 'https://res.cloudinary.com/shubhamcloudinary/image/upload/v1766135141/Homebuddy24/electricity/service/switch-socket.jpg',
            badge: '',
